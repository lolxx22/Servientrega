...
export const RegisterPage = () => {
  ...
  const strengthColors = ['bg-neutral-200', 'bg-danger', 'bg-warning', 'bg-amber-500', 'bg-brand-green-600'];
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 mesh-gradient-dark relative overflow-hidden flex items-center justify-center p-8 lg:p-12">
        ...
        {/* Floating accents */}
        <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-brand-green-600/10 rounded-full blur-3xl" />
        ...
        >
          ...
          <div className="space-y-3">
            {features.map(({ text }, i) => (
              ...
              >
                <div className="w-8 h-8 rounded-full bg-brand-green-400/10 border border-brand-green-400/20 flex items-center justify-center flex-shrink-0">
          ...
          {/* Stats */}
          <div className="flex items-center justify-center gap-6 pt-10 mt-10 border-t border-white/10">
            {[
        ...
        >
                    ...
                    {[1, 2, 3, 4].map((level) => (
                      <div
                        ...
                        className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                          level <= strength ? strengthColors[strength] : 'bg-neutral-100'
                        }`}
                      />
                    ))}
                  </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-neutral-500">
              ...
              <Link to="/login" className="font-semibold text-brand-green-600 hover:text-brand-green-900 transition-colors">
                Inicia sesión
              </Link>
            </p>
          </div>
